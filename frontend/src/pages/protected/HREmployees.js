...
function HREmployees() {
  ...
  const loadReferenceData = useCallback(async () => {
    try {
      ...
      if (metaPositions.length > 0) {
        setPositions(
          metaPositions.sort((a, b) => a.name.localeCompare(b.name)),
        );
        return;
      }
  ...
  const departments = useMemo(() => {
    const unique = Array.from(
      new Set(positions.map((item) => item.department_name).filter(Boolean)),
    );
  ...
  const filteredPositions = useMemo(() => {
    ...
    return positions.filter(
      (position) =>
        normalizeText(position.department_name) === normalizedDepartment,
    );
  ...
  const hasSelectedDocuments = (documents) => {
    return Boolean(
      ...
      documents.diploma_document ||
      documents.employment_contract_document,
    );
  };
  ...
  const handleCreateEmployee = async (event) => {
    ...
    if (!createForm.position_id || !createForm.join_date) {
      dispatch(
        showNotification({
          message: "Posisi dan tanggal bergabung wajib diisi",
          status: 0,
        }),
      );
      return;
    ...
    try {
      ...
      if (createdStaff?.employee_id && hasSelectedDocuments(createDocuments)) {
        ...
        if (createDocuments.ktp_document)
          formData.append("ktp_document", createDocuments.ktp_document);
        if (createDocuments.diploma_document)
          formData.append("diploma_document", createDocuments.diploma_document);
        if (createDocuments.employment_contract_document)
          formData.append(
            "employment_contract_document",
            createDocuments.employment_contract_document,
          );
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      if (hasNewDocument) {
        ...
        formData.append(
          "position_id",
          editingEmployee.position_id
            ? String(editingEmployee.position_id)
            : "",
        );
        formData.append("join_date", editingEmployee.join_date || "");
        formData.append(
          "basic_salary",
          editingEmployee.basic_salary
            ? String(editingEmployee.basic_salary)
            : "",
        );
        formData.append(
          "employment_status",
          editingEmployee.employment_status || "",
        );
        ...
        if (editDocuments.employment_contract_document)
          formData.append(
            "employment_contract_document",
            editDocuments.employment_contract_document,
          );
        ...
        await hrApi.updateEmployee(editingEmployee.id, {
          ...
          position_id: editingEmployee.position_id
            ? Number(editingEmployee.position_id)
            : undefined,
          join_date: editingEmployee.join_date,
          basic_salary: editingEmployee.basic_salary
            ? Number(editingEmployee.basic_salary)
            : undefined,
          ...
          user_status: editingEmployee.user_status || editingEmployee.status,
          status: editingEmployee.user_status || editingEmployee.status,
        });
      }
  ...
  const confirmDeleteEmployee = async () => {
    ...
    try {
      ...
      dispatch(
        showNotification({ message: "Pegawai berhasil dihapus", status: 1 }),
      );
  ...
  return (
    <>
      ...
      >
        <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 gap-4 mb-6">
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text">Status Kepegawaian</span>
            </label>
            <select
              className="select select-bordered"
    ...
    `}
          ...
          <form className="space-y-4 mt-4" onSubmit={handleCreateEmployee}>
            <div className="border border-base-300 rounded-lg p-4">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                ...
                <select
                  className="select select-bordered"
                  value={createForm.user_status}
                  onChange={(e) =>
                    updateCreateForm("user_status", e.target.value)
                  }
                >
            ...
            <div className="border border-base-300 rounded-lg p-4">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCreateForm("birth_place", e.target.value)
                  }
                />
                <input
                  className="input input-bordered"
                  ...
                  onChange={(e) =>
                    updateCreateForm("date_of_birth", e.target.value)
                  }
                />
                <select
                  className="select select-bordered"
                  ...
                  onChange={(e) =>
                    updateCreateForm("marital_status", e.target.value)
                  }
                >
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCreateForm("nationality", e.target.value)
                  }
                />
                <input
                  className="input input-bordered"
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCreateForm("bank_account", e.target.value)
                  }
                />
                <input
                  className="input input-bordered"
                  ...
                  onChange={(e) =>
                    updateCreateForm("account_holder_name", e.target.value)
                  }
                />
                <input
                  className="input input-bordered"
                  ...
                  onChange={(e) =>
                    updateCreateForm("bank_name", e.target.value)
                  }
                />
                <input
                  className="input input-bordered lg:col-span-2 md:col-span-2"
                  placeholder="Alamat"
            ...
            <div className="border border-base-300 rounded-lg p-4">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateCreateForm("position_id", e.target.value)
                  }
                >
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCreateForm("join_date", e.target.value)
                  }
                />
                <select
                  className="select select-bordered"
                  ...
                  onChange={(e) =>
                    updateCreateForm("employment_status", e.target.value)
                  }
                >
            ...
            <div className="border border-base-300 rounded-lg p-4">
              ...
              <p className="text-xs text-base-content/70 mb-2">
                Role ditentukan otomatis berdasarkan departemen dan posisi.
              </p>
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCreateDocuments((prev) => ({
                        ...prev,
                        ktp_document: e.target.files?.[0] || null,
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCreateDocuments((prev) => ({
                        ...prev,
                        diploma_document: e.target.files?.[0] || null,
                      }))
                    }
                  />
                </div>
            ...
            <div className="space-y-4 mt-4">
              <div className="flex flex-col items-center justify-center">
                <div className="avatar">
                  <div className="w-24 rounded-xl ring ring-base-300 ring-offset-base-100 ring-offset-2">
                    <img
                      src={getEmployeePhotoUrl(viewingEmployee.photo)}
                      alt="Foto Pegawai"
                    />
                  </div>
                </div>
                <p className="mt-2 font-semibold">
                  {getDisplayValue(
                    viewingEmployee.name || viewingEmployee.full_name,
                  )}
                </p>
                <p className="text-xs text-base-content/70">
                  {getDisplayValue(viewingEmployee.employee_code)}
                </p>
              </div>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-2 w-full">
                  ...
                  <div>
                    ...
                    {getDisplayValue(viewingEmployee.email)}
                  </div>
                  <div>
                    <span className="font-semibold">Username:</span>{" "}
                    {getDisplayValue(viewingEmployee.username)}
                  </div>
                  <div>
                    <span className="font-semibold">Telepon:</span>{" "}
                    {getDisplayValue(viewingEmployee.phone)}
                  </div>
                  <div>
                    <span className="font-semibold">Status Pengguna:</span>{" "}
                    {getDisplayValue(
                      viewingEmployee.user_status || viewingEmployee.status,
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                <p className="font-semibold mb-3">
                  Data Pribadi & Administrasi
                </p>
                <div className="grid md:grid-cols-2 grid-cols-1 gap-2">
                  <div>
                    <span className="font-semibold">Jenis Kelamin:</span>{" "}
                    {getDisplayValue(viewingEmployee.gender)}
                  </div>
                  <div>
                    <span className="font-semibold">Tempat Lahir:</span>{" "}
                    {getDisplayValue(viewingEmployee.birth_place)}
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    {getDisplayValue(viewingEmployee.marital_status)}
                  </div>
                  <div>
                    <span className="font-semibold">Kewarganegaraan:</span>{" "}
                    {getDisplayValue(viewingEmployee.nationality)}
                  </div>
                  <div>
                    <span className="font-semibold">NIK:</span>{" "}
                    {getDisplayValue(viewingEmployee.nik)}
                  </div>
                  <div>
                    <span className="font-semibold">NPWP:</span>{" "}
                    {getDisplayValue(viewingEmployee.npwp)}
                  </div>
                  <div>
                    <span className="font-semibold">Nomor BPJS:</span>{" "}
                    {getDisplayValue(viewingEmployee.bpjs_number)}
                  </div>
                  <div>
                    <span className="font-semibold">Nomor Rekening:</span>{" "}
                    {getDisplayValue(viewingEmployee.bank_account)}
                  </div>
                  <div>
                    <span className="font-semibold">
                      Nama Pemilik Rekening:
                    </span>{" "}
                    {getDisplayValue(viewingEmployee.account_holder_name)}
                  </div>
                  <div>
                    <span className="font-semibold">Nama Bank:</span>{" "}
                    {getDisplayValue(viewingEmployee.bank_name)}
                  </div>
                  <div className="md:col-span-2">
                    <span className="font-semibold">Alamat:</span>{" "}
                    {getDisplayValue(viewingEmployee.address)}
                  </div>
                </div>
              </div>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-2">
                  <div>
                    ...
                    {getDisplayValue(viewingEmployee.department_name)}
                  </div>
                  <div>
                    <span className="font-semibold">Posisi:</span>{" "}
                    {getDisplayValue(viewingEmployee.position_name)}
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    {getDisplayValue(viewingEmployee.employment_status)}
                  </div>
                  <div>
                    <span className="font-semibold">Gaji Pokok:</span>{" "}
                    {formatRupiah(viewingEmployee.basic_salary)}
                  </div>
                </div>
              </div>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                <p className="font-semibold mb-3">Role & Hak Akses</p>
                <div className="flex flex-wrap gap-2">
                  {(viewingEmployee.roles || []).length ? (
                    (viewingEmployee.roles || []).map((roleName) => (
                      <span
                        key={roleName}
                        className="badge badge-outline capitalize"
                      >
                    ...
                    <span className="text-xs text-base-content/70">
                      Role tidak tersedia pada data ini
                    </span>
                  )}
                </div>
              </div>
      ...
      <input
        type="checkbox"
        id="delete-employee-modal-hr"
        className="modal-toggle"
        checked={!!deleteTarget}
        onChange={() => setDeleteTarget(null)}
      />
      <div className="modal">
        <div className="modal-box max-w-md">
          ...
          {deleteTarget ? (
            <div className="mt-3 space-y-2">
              ...
              <div className="rounded-lg border border-base-300 p-3 bg-base-200/40">
                <div className="flex items-center gap-3 mb-3">
                  <div className="avatar">
                    <div className="w-14 rounded-lg">
                      <img
                        src={getEmployeePhotoUrl(deleteTarget.photo)}
                        alt="Foto Pegawai"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <p className="text-xs opacity-70">
                      {getDisplayValue(deleteTarget.employee_code)}
                    </p>
                  </div>
                </div>
                <p>
                ...
                <p>
                  <span className="font-semibold">Nama:</span>{" "}
                  {getDisplayValue(deleteTarget.full_name || deleteTarget.name)}
                </p>
                <p>
                  <span className="font-semibold">Departemen:</span>{" "}
                  {getDisplayValue(deleteTarget.department_name)}
                </p>
                <p>
                  <span className="font-semibold">Posisi:</span>{" "}
                  {getDisplayValue(deleteTarget.position_name)}
                </p>
              </div>
          ...
          <div className="modal-action">
            ...
            <button
              className={`btn btn-error ${submitting ? "loading" : ""}`}
            ...
            <div className="space-y-4 mt-4">
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
                  ...
                  <select
                    className="select select-bordered"
                    value={editingEmployee.user_status || "active"}
                    onChange={(e) =>
                      setEditingEmployee({
                        ...editingEmployee,
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
                  ...
                  <input
                    className="input input-bordered"
                    placeholder="Tempat Lahir"
                    value={editingEmployee.birth_place || ""}
                    onChange={(e) =>
                      setEditingEmployee({
                        ...editingEmployee,
                  ...
                  <input
                    className="input input-bordered"
                    placeholder="Nama Pemilik Rekening"
                    value={editingEmployee.account_holder_name || ""}
                    onChange={(e) =>
                      setEditingEmployee({
                        ...editingEmployee,
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
                  <select
                    className="select select-bordered"
                    value={editingEmployee.department_name || ""}
                    onChange={(e) =>
                      setEditingEmployee({
                        ...editingEmployee,
                        department_name: e.target.value,
                  ...
                  <select
                    className="select select-bordered"
                    value={editingEmployee.employment_status || "permanent"}
                    onChange={(e) =>
                      setEditingEmployee({
                        ...editingEmployee,
                  ...
                  <p className="text-xs text-base-content/70 md:col-span-2">
                    Gaji pokok ditentukan otomatis berdasarkan posisi.
                  </p>
                </div>
              </div>
              ...
              <div className="border border-base-300 rounded-lg p-4">
                <p className="font-semibold mb-3">Role & Hak Akses</p>
                <p className="text-xs text-base-content/70 mb-2">
                  Preview role otomatis dari departemen dan posisi.
                </p>
                <div className="flex flex-wrap gap-2">
                  {(liveEditRoles || []).length ? (
                    (liveEditRoles || []).map((roleName) => (
                      <span
                        key={roleName}
                        className="badge badge-outline capitalize"
                      >
              ...
              <div className="border border-base-300 rounded-lg p-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-3 mb-3">
                  <div className="text-xs text-base-content/70">
                    KTP saat ini:{" "}
                    {getDocumentFileName(editingEmployee.ktp_document)}
                  </div>
                  <div className="text-xs text-base-content/70">
                    Ijazah saat ini:{" "}
                    {getDocumentFileName(editingEmployee.diploma_document)}
                  </div>
                  <div className="text-xs text-base-content/70">
                    Kontrak saat ini:{" "}
                    {getDocumentFileName(
                      editingEmployee.employment_contract_document,
                    )}
                  </div>
                </div>
