...
function Layout() {
  ...
  return (
    <>
      ...
      <div className="drawer lg:drawer-open min-h-screen text-base-content">
        <input
      ...
      {showProfilePrompt ? (
        <div className="modal modal-open">
          <div className="modal-box app-card">
            ...
            <div className="modal-action">
              <button
                className="btn btn-ghost app-pill"
      ...
      {isAccountLocked ? (
        <div className="modal modal-open">
          <div className="modal-box app-card">
            ...
            <p className="py-4">
              Akun Anda sedang tidak aktif. Semua akses sistem dikunci. Silakan
              hubungi HR/Admin untuk tindak lanjut.
            </p>
            <div className="modal-action">
              <button
